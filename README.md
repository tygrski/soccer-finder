...
## To run this app copy and paste the [repo](https://github.com/tygrski/soccer-finder) to your computer. Open the file in youe IDE and open the HTML page in your browser. 
## Purpose 
